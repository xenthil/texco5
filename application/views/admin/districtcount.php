...
<script type="text/javascript" src="<?php echo base_url("assets/js/app/districtcount.js")?>"></script>
   ...
   <div class="row">
      <div class="container">
         <div class="col s12 m6 l6">
            <div class="pagebannertext white-text" >District Count (Salaried Personnelwise)</div>
         </div>
         <div class="col s12 m6 l6 right-align">
            <div class="dumheight hide-on-small-only"> </div>
            <div class=""> <a href="<?php echo base_url('admin/dashboard')?>" class="breadcrumb">Home</a><span class="breadcrumb">Reports</span>  <span class="breadcrumb">District Count</span> </div>
         </div>
      </div>
   </div>
   <div class="parallax"><img src="<?php echo base_url("assets/images/breadcrumbbanner.jpg")?>"></div>
</div>
<div  class="row" ng-app="appDistrictcount" style="padding-top:30px;">
   <div  class="container" ng-controller="ctrlDistrictcount">
            ...
            <div class="col s12 m6 l6">
               <div class="card blue-grey lighten-1">
                  ...
                  <div class="card-content white-text">
                     ...
                     <button ng-click="submitdistrictcount(objproject)" class="btn cyan waves-effect waves-light" type="submit">View District Count
               ...
               <div class="card blue-grey lighten-1">
                  <div class="card-action">
                   <div class="card-content white-text">
                     ...
                     <button ng-click="exportdistrictcount(objproject)" class="btn cyan waves-effect waves-light" type="submit" >Export District Count
                     <i class="mdi-content-send right"></i>
                     </button>
         ...
         <table ng-table="tableParams" class="responsive-table highlight striped" fixed-table-headers="scrollable-area" show-filter="true" class="bordered">
            <tbody ng-repeat="applied in $data">
               <tr>
                  ...
                  <td width="7%" data-title="'JA'" filter="{JA: 'text'}" sortable="'JA'">  
                     {{applied.JA}}</td>
