      ...
      <div class ="col s12 m12 l12">
         <div class="row">
            <div class="input-field col s4">
               <select id="projectno" name="projectno" class="validate" ng-class="{'submitted': submitted && objinvoice.projectno.$invalid}" ng-model="objinvoice.projectid"
                              data-ng-options=" p.projectid as p.projectno for p in projectnos"
                              ng-change="fillclientproject(objinvoice.projectid)" >
                                 <option value="">ALL</option>
                              </select>
                                       <label for="projectno">Project No</label>
            </div>
            <div class="input-field col s4">
               <select id="project" name="project" class="validate"  ng-required="true"  ng-class="{'submitted': submitted && objinvoice.project.$invalid}"  ng-model="objinvoice.projectid" data-ng-options=" p.projectid as p.name for p in selectedprojects" ng-change="monthclear()">
                  <option value="">ALL</option>
               </select>
         ...
         <div class="row">
            ...
            <div class="col s12 m6 l6">
               <div class="card blue-grey lighten-1">
                  <div class="card-action">
                     <div class="card-content white-text">
                        <p class="text-black">You can Export all Invoice to an excel file.</p>
                     </div>
         ...
         <table ng-table="tableParams" class="responsive-table highlight striped" show-filter="true" class="bordered">
            <tbody ng-repeat="item in $data">
               <tr>
                  ...
                  <td width="4%" data-title="'TOT PERSON'" filter="{noperson: 'text'}" sortable="'noperson'">{{item.noperson}} </td>
