      ...
      <div class ="col s12 m12 l12">
         <!-- <div class="row">
            <div class="input-field col s4">
               <select name="districtid" ng-model="objemployee.districtid"  data-ng-options=" d.lkvalid as d.description for d in district">  
         ...
         <div class="row">
            ...
            <div class="col s12 m6 l6">
               <div class="card blue-grey lighten-1">
                  <div class="card-action">
                   <div class="card-content white-text">
                     <p class="text-black">You can Export all employees to an excel file.</p>
                      </div>
                     <button class="btn cyan waves-effect waves-light" type="button" ng-csv="exportemployee" 
                     filename="Employee_Details.csv" csv-header="['FIRST NAME', 'LAST NAME', 'FATHER NAME', 'DOB', 'EMAIL',
            'MOBILE NO','ADDRESS', 'COMUNICATION ADDRESS', 'AADHAAR NO', 'ACCOUNT NO', 'NOMINEE', 'ESMID NO',
            'CIVIL QUALIFICATION', 'ARMY QUALIFICATION', 'DEPENDENT STATUS', 'DEPENDENT NAME', 'NATIONALITY', 
            'REGISTRATION NO','LAST ACCESS', 'SERVICE NO', 'TEXCO NO']" charset="utf-8">Export Employee
                     <i class="mdi-content-send right"></i>
                     </button>
                  </div>
               </div>
         ...
         <!-- <div class="row">
         <div class="col s12 m12 l12">
            <button type="button" class="btn btn-default btncol" ng-csv="exportemployee" 
            filename="Employee_Details.csv" csv-header="['FIRST NAME', 'LAST NAME', 'FATHER NAME', 'DOB', 'EMAIL',
            'MOBILE NO','ADDRESS', 'COMUNICATION ADDRESS', 'AADHAAR NO', 'ACCOUNT NO', 'NOMINEE', 'ESMID NO',
            'CIVIL QUALIFICATION', 'ARMY QUALIFICATION', 'DEPENDENT STATUS', 'DEPENDENT NAME', 'NATIONALITY', 
            'REGISTRATION NO','LAST ACCESS', 'SERVICE NO', 'TEXCO NO']" charset="utf-8" 
            style="background: green;color: #fff !important;float:right;margin:10px;"><span class="glyphicon 
            glyphicon-download-alt">&nbsp;</span>Download</button>
            &nbsp;&nbsp;
         </div>
         </div> -->
