...
<script type="text/javascript" src="<?php echo base_url("assets/js/app/tncountreport.js")?>"></script>
   ...
   <div class="row">
      <div class="container">
         <div class="col s12 m6 l6">
            <div class="pagebannertext white-text" >TN Count</div>
         </div>
         <div class="col s12 m6 l6 right-align">
            ...
            <span class="breadcrumb">Reports</span> 
             <span class="breadcrumb">TN Count</span> </div>
         </div>
      </div>
   </div>
   <div class="parallax"><img src="<?php echo base_url("assets/images/breadcrumbbanner.jpg")?>"></div>
</div>
<div  class="row" ng-app="appTncountreport" style="padding-top:30px;">
   <div  class="container" ng-controller="ctrlTncountreport">
            ...
            <div class="col s12 m6 l6">
               <div class="card blue-grey lighten-1">
                  ...
                  <div class="card-content white-text">
                     ...
                     <button ng-click="submittncount(objproject)" class="btn cyan waves-effect waves-light" type="submit">View TN Count
                  ...
                  <div class="card-action">
                   <div class="card-content white-text">
                     <p class="text-black">You can Export all projects to an excel file.</p>
                      ...
                      <!-- ng-click="exporttncount(objproject)" -->
                     <button ng-click="exporttncount(objproject)" class="btn cyan waves-effect waves-light" type="submit" >Export TN Count
                     <i class="mdi-content-send right"></i>
                     </button>
