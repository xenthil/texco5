<script type="text/javascript" src="<?php echo base_url("assets/js/app/searchmembers.js")?>"></script>
   ...
   <div class="row">
      <div class="container">
         <div class="col s12 m6 l6">
            <div class="pagebannertext white-text">Employees Search</div>
         </div>
         <div class="col s12 m6 l6 right-align">
            <div class="dumheight hide-on-small-only"> </div>
            <div class=""> <a href="<?php echo base_url('admin/dashboard') ?>" class="breadcrumb">Home</a> 
            <span class="breadcrumb">Master</span><span class="breadcrumb">Employees</span> </div>
         </div>
      </div>
   </div>
...
<div class="row" ng-app="appAdminSearchMember">
   <div class="container" ng-controller="ctrlAdminSearchMember">
      <!-- Modal Structure -->
      <?php echo $newmember ?>
                  ...
                  <div class="row">
                     ...
                     <form ng-submit="profileform.$valid && savemember(objprofile)" id="profileform" name="profileform" novalidate>
                        <div class="row">
                           ...
                           <div class="input-field col s6 l2">
                              <input name="dob" ng-required="true" type="text" class="month_year" ng-class="{'submitted': submitted && profileform.dob.$invalid}" data-ng-model="objprofile.dob">
                              <label for="dob" data-error="Required" class="active">Date of Birth</label>
                           </div>
                            <div class="input-field col s6 l2">
                        ...
                        <div class="row"> 
                           ...
                           <div class="input-field col s6 l2">
                              ...
                              <input class="month_year" id="doj" name="doj" type="text" data-ng-model="objprofile.doj" ng-class="{'submitted': submitted && profileform.dob.$invalid}" autocomplete="off"> 
                ...
                <tbody ng-repeat="searchmember in members">
                    <tr>
                        ...
                        <td width="20%" data-title="'View'" style="text-align: center;">
                            <button ng-click="combinememberByID(searchmember.memberid,members)" style="background: green;color: #fff !important;" class="modal-action waves-effect waves-green btn-flat" type="submit">Combine</button>
                            &nbsp;&nbsp;
                            <button ng-click="deletememberByID(searchmember.memberid)" style="background: red;color: #fff !important;" class="modal-action waves-effect waves-green btn-flat" type="submit">Delete</button>
                        </td>
                    </tr>
                </tbody>
            </table>
