   ...
   <div class="row">
      <div class="container">
         <div class="col s12 m6 l6">
            <div class="pagebannertext white-text" >Posted List Report</div>
         </div>
         <div class="col s12 m6 l6 right-align">
            <div class="dumheight hide-on-small-only"> </div>
            <div class=""> <a href="<?php echo base_url('admin/dashboard')?>" class="breadcrumb">Home</a>  <span class="breadcrumb">Reports</span>  <span class="breadcrumb">Posted List Report</span> </div>
         </div>
      </div>
   </div>
         ...
         <div class="row">
            <div class="col s12 m6 l6">
               <div class="card blue-grey lighten-1">
                  ...
                  <div class="card-content white-text">
                     <p class="text-black">You can View Current Posted List.</p>
                  </div>
                     <button ng-click="submitpostedlist(objjobposting)" class="btn cyan waves-effect waves-light" type="submit">View Posted List
            ...
            <div class="col s12 m6 l6">
               <div class="card blue-grey lighten-1">
                  <div class="card-action">
                   <div class="card-content white-text">
                     <p class="text-black">You can Export posted list to an excel file.</p>
                      </div>
                     <button ng-click="exportpostedlist(objjobposting)" class="btn cyan waves-effect waves-light" type="submit">Export Posted List
                     <i class="mdi-content-send right"></i>
                     </button>
                  </div>
               </div>
            ...
            <tbody ng-repeat="applied in $data">
               <tr>
                 ...
                 <td width="8%" data-title="'FATHERNAME'" filter="{fathername: 'text'}" sortable="'fathername'">{{applied.fathername}}</td>
                  ...
                  <td width="10%" data-title="'POSTED DATE'" filter="{posteddate: 'text'}" sortable="'posteddate'">{{applied.posteddate}} </td>
