               ...
               <table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                     ...
                     <div ng-show="invoiceprint.pfprintcount>0"> Duplicate Copy</div>
                         <div ng-show="invoiceprint.pfprintcount==0">Orginal Copy</div>
               ...
               <table style="border-collapse: collapse;" border="1" width="97%" cellspacing="0" cellpadding="0" align="center">
                  ...
                  <tbody style="font-size: 14px;">
                     <tr ng-repeat="x in payslip" style="font-size: 14px;">
                        ...
                        <td align="center">
                           &nbsp;{{x[0].members.firstname}}&nbsp; 
                           <hr>
                           {{x[0].members.firstname}}&nbsp;
                        </td>
                       <!--  <td>&nbsp;{{x[0].members.firstname}}</td> -->
                        <td class="capitalize">&nbsp;{{x[0].members.firstname}}</td>
                        <td style="text-align: center;">&nbsp;{{x.jobcode}}</td>
                        <td align="center">&nbsp;{{x[2].diff.presentdays}}</td>
                        <td align="right">&nbsp;{{x[2].diff.basic | number:2}}&nbsp;&nbsp;</td>
                        <td align="right">&nbsp;{{x[2].diff.epf | number:2}} &nbsp;&nbsp;</td>
                        <td align="right">&nbsp;{{x[2].diff.epf | number:2}} &nbsp;&nbsp;</td>
                     </tr>
                     <tr>
