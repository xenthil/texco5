<script type="text/javascript" src="<?php echo base_url("assets/js/app/document.js")?>">
</script>
...
<div class="row" ng-app="appDocument">
    <div class="container" ng-controller="ctrlDocument">
                ...
                <div class="row" style="padding: 40px;">
                    <form ng-submit="documentform.$valid && savedocument(objdocument,picFile)" id="documentform" name="documentform" novalidate>
                        <div class="row" style="padding: 24px;">
                            <div class="col s12">
                                <input type="hidden" ng-model="objdocument.documentid">
                                <div class="row">
        ...
        <div id="modal2" class="modal modal-fixed-footer" style="max-width: 75%;max-height:90%;height:40%;width: 40%;">
            <div class="modal-content" style="overflow: hidden;">
                <nav class="blue" style="position: fixed;margin-top: 0px; z-index:999;">
                    ...
                    <div class="col s11 m11 l11">
                        <div class="li white-text" id="mcaption">Create Folder</div>
                    </div>
                </nav>
                <div class="row" style="padding: 40px;">
                    <form ng-submit="documentfolder.$valid && savefolder(objfolder)" id="documentfolder" name="documentfolder" novalidate>
                    <div class="row" style="padding: 24px;">
                        <div class="col s12">
                            <div class="row">
                                <div class="input-field col s6">
                                    <input id="name" name="foldername" type="text" ng-class="{'submitted': submitted && documentfolder.foldername.$invalid}" class="validate" type="text" ng-model="objfolder.foldername" maxlength="30" ng-required="true" ng-minlength="2" aria-required="true">
                                    <label for="foldername" data-error="Folder Name Required">Folder Name</label>
                                    <!-- <label for="foldername" data-error="Required">Folder Name Already Exists</label> --> 
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col s12 ">
                    <div id="Client-list" class="CLheight col s12 m4 l4 card-panel z-depth-1">
                        <ul class="collection"> 
                        <select id="foldername" name="foldername" class="validate" ng-model="foldername" ng-change="getchangefoldervalues(foldername)"> 
                            <option value="0">All</option> 
                            <option ng-repeat="folvals in folders" value="{{folvals.folderid}}">{{folvals.foldername}}</option> 
                        </select>
                            <div class="row">
                                <div class="col s12">
                                    <nav class="indigo">
                            ...
                            <div class= "scroll">
                            <li class="collection-item avatar waves-effect waves-teal col s12" ng-class="{selected: document.documentid === selected.documentid}" ng-repeat="document in documents | filter: filter">
                                <a href="javascript::void(0)" ng-click="select(document)">
                                    <div style="margin-top: 10px;">
                                        <i class="material-icons circle {{document.iconcolour}}">{{document.icon}}</i>
                                        <span class="title">{{document.name}}</span>
                                        <p class="truncate grey-text ultra-small">{{document.documentname}}</p>
                                    </div>
                                </a>
                            </li>
                            </div>
                        ...
                        <div class="email-content-wrap">
                            <div class="row z-depth-1" style="background-color: #eee;">
                                ...
                                <div class="col s2 m2 l2 right-align resultframe">
                                    ...
                                    <?php } ?>
                                    <?php if($roledata['permissions']['DDOCUMENTS']==1) {?>
                                    <a ng-click='removedocument()'><span><i class="small icon mdi mdi-delete"></i></span></a>
                                    <?php } ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col  s12 m6 l6">
                                    ...
                                    <p>{{selected.documentname}}</p>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col s12 m6 l6">
                                    <p class="blue-grey-text"><strong>Icon</strong> </p>
                                    <p>{{selected.icon}} </p>
                                </div>

                                <div class="col  s12 m6 l6">
                                    <p class="blue-grey-text"><strong>Iconcolour</strong> </p>
                                    <p>{{selected.iconcolour}}</p>
                                </div>
                            </div>
