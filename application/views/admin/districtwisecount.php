   ...
   <div class="row">
      <div class="container">
         <div class="col s12 m6 l6">
            <div class="pagebannertext white-text" >District Count (Agreement Wise)</div>
         </div>
         <div class="col s12 m6 l6 right-align">
            <div class="dumheight hide-on-small-only"> </div>
            <div class=""> <a href="<?php echo base_url('admin/dashboard')?>" class="breadcrumb">Home</a> 
            <span class="breadcrumb">Reports</span> <span class="breadcrumb">District Count</span> </div>
         </div>
      </div>
   </div>
            ...
            <div class="col s12 m6 l6">
               <div class="card blue-grey lighten-1">
                  ...
                  <div class="card-content white-text">
                     ...
                     <button ng-click="submitdistrictwisecount()" class="btn cyan waves-effect waves-light" type="submit">View Districtwise Count
               ...
               <div class="card blue-grey lighten-1">
                  <div class="card-action">
                   <div class="card-content white-text">
                     ...
                     <button ng-click="exportdistrictwisecount()" class="btn cyan waves-effect waves-light" type="submit" >Export Districtwise Count
                     <i class="mdi-content-send right"></i>
                     </button>
