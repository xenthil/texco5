       ...
       <br><br>  
        ...
        <div class="row">
            <div class="input-field col s2">
                <input id="texcono" type="text" ng-model="objprofile.texcono">
                <label for="texcono" class="dp-click">Texco number</label>
            </div>
            <!-- <div class="input-field col s2">
            ...
            <div class="input-field col s2">
                <button ng-click="getMemberHistory(objprofile)" class="btn cyan waves-effect waves-light" type="submit">Search
        ...
        <div id="editpostorder"  class="modal modal-fixed-footer" aria-hidden="true" style="width: 65% !important;">
                        ...
                        <form class="col s12">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s5 m5 l5">
                                    ...
                                    <input id="enddates" type="date" class="datepicker" ng-model="memhistory.enddate" placeholder="End Date" ng-required="true" ng-class="{'submitted': submitted && memhistory.enddate.$invalid}" ng-value="memhistory.enddate">
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal-footer">
                <a ng-click="editMemberhistory(memhistory)" class="waves-effect waves-green btn-flat modal-action modal-close">Update</a> &nbsp;&nbsp;&nbsp;
