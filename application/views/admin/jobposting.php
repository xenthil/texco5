    ...
    <div class="container">
      ...
      <div class="col s12 m6 l6 right-align">
        ...
        <div class=""> 
          ...
          <span class="breadcrumb">Job Posting</span> 
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row">
              ...
              <div class="input-field col s12">
                ...
                <table>
                  ...
                  <tr>
                    <th>Postings</th>
                    <th style="width: 12%;">Vacancy</th>
                    <th>Comments</th>
                    <th>Inplace</th>
                  </tr>
                  <tr ng-repeat="l in jobmasteragreement">
                    <td><input ng-model="l.jobpostingdetailid" type="hidden"> {{l.jobmastercode}} </td>
              ...
              <div class="col s12">
                ...
                <div class="row" id="divProjAdd">
                  ...
                  <div class="input-field col s6">
                    ...
                    <label for="startdate" class="dp-click "></label>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="input-field col s12">
                    <table>
                      ...
                      <tr ng-repeat="l in jobmasteragreement">
                        <td ng-if="l.numberofvacancies == 0"><input ng-model="l.jobpostingdetailid" type="hidden"> {{l.code}}</td>
                        <td ng-if="l.numberofvacancies != 0"><input ng-model="l.jobpostingdetailid" type="hidden"> {{l.jobmastercode}}</td>
                        <td><input ng-model="l.numberofvacancies" id="{{l.jobmasterid}}" max="{{l.maxvalue}}" min="0" value="{{l.numberofvacancies | number}}" class="validate" type="number" pattern="[0-9]*" ng-required="true" min="0"> </td>
                        <td><input ng-model="l.comments" id="{{l.jobmasterid}}" value="{{l.comments}}" class="validate" type="text"> </td>
                        <td><input ng-model="l.inplace" id="{{l.jobmasterid}}" value="{{l.inplace}}" class="validate" type="text"> </td>
                      </tr>
                ...
                <div class="row">
                  <div class="input-field col s12">
                    <table>
                      ...
                      <tr ng-repeat="l in jobmasteragreement">
                        {{l}}
                        <td><input ng-model="l.jobpostingdetailid" type="hidden"> {{l.code}}</td>
                        <td><input ng-model="l.numberofvacancies" id="{{l.jobmasterid}}" max="{{l.maxvalue}}" min="0" value="{{l.numberofvacancies | number}}" class="validate" type="number" pattern="[0-9]*" ng-required="true" min="0"> </td>
                        <td><input ng-model="l.comments" id="{{l.jobmasterid}}" value="{{l.comments}}" class="validate" type="text"> </td>
                        <td><input ng-model="l.inplace" id="{{l.jobmasterid}}" value="{{l.inplace}}" class="validate" type="text"> </td>
                      </tr>
            ...
            <div class="email-content-wrap">
              <div class="row z-depth-1" style="background-color: #eee;">
                ...
                <div class="col s2 m2 l2 right-align  resultframe">
                  <!-- {{objjobposting}} -->
                  <a id="editjobposting" ng-click='editjobposting(objjobposting.jobpostingid,objjobposting.projectid)'><span><i class="small icon darken-1 mdi mdi-account-edit"></i></span></a>
