   ...
   <div class="row">
      <div class="container">
         ...
         <div class="col s12 m6 l6 right-align">
            ...
            <span class="breadcrumb">Jobs</span><span class="breadcrumb">Manage Jobs</span> </div>
         </div>
      </div>
   </div>
            ...
            <div class="col s12 m12 l6">
               <div class="card blue-grey lighten-1">
                  <div class="card-content white-text" style="height:200px;">
                     ...
                     <p class="text-black">You can select CLOSE DATE and import all the vacancies for this week from an excel file.</p>
                     <div class="row" style="padding-left: 25px;">
                        <div class="input-field col m6 s6" style="background-color:white;color: #a29898">
                           ...
                           <label for="closedate" class="dp-click datepickercls"></label>
                        </div>
                     </div>
                     <form action="#">
               ...
               <div class="card blue-grey lighten-1">
                  ...
                  <div class="row" style="padding-left: 25px;">
                     ...
                     <div class="input-field col m6 s6" style="background-color:white;color: #a29898">
                        ...
                        <label for="closedate" class="dp-click"></label>
                     </div>
                  </div>
               </div>
            </div> -->
