                    ...
                    <tbody ng-repeat="applied in $data">
                        ...
                        <td width="8%" data-title="'serviceno'" filter="{serviceno: 'text'}"
                            ...
                            <td width="10%" data-title="'Training Required'" filter="{trainingRequired: 'text'}"
                                sortable="'trainingRequired'"><span ng-repeat="a in applied.trainingRequired track by $index">{{a.code}}</span></td>

                            <td width="5%" data-title="'Document'" filter="{documentPath: 'text'}"
                                sortable="'documentPath'">
                                {{applied.documentPath}}</td>
                                <td width="8%" data-title="'Type'" filter-data="types"   filter="{type: 'select'}"
                                sortable="'type'">
                                {{applied.type}}</td>
                            ...
                            <td width="8%" data-title="'Status'" filter="{approvalStatus: 'text'}"
                                sortable="'approvalStatus'">
                              <span ng-show="applied.approvalStatus==1">  Approved</span>
                              <span ng-show="applied.approvalStatus==2">  Rejected</span>
                              <span ng-show="applied.approvalStatus==0">  Pending</span>
                            
                            </td>

                            <td width="8%" data-title="'Authorize'">
                               
                                    <a ng-show="applied.approvalStatus!=1" class="btn-floating btn-small blue"
                                        ng-click="approvedependent(applied.dependentId,'1',applied.type)">
                                        <i class="material-icons">done</i>
                                    </a>
                                    <a class="btn-floating btn-small red"
                                        ng-click="approvedependent(applied.dependentId,'2',applied.type)">
