    ...
    <div class="row">
        <div class="container">
            <div class="col s12 m6 l6">
                <div class="pagebannertext white-text">New Personnel List</div>
            </div>
            <div class="col s12 m6 l6 right-align">
                <div class="dumheight hide-on-small-only"> </div>
                <div class=""> <a href="<?php echo base_url('admin/dashboard') ?>" class="breadcrumb">Home</a> <span class="breadcrumb">Account Reports</span>  <span class="breadcrumb">New Personnel List</span> </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card blue-grey lighten-1">
                        <div class="card-action">
                            <div class="card-content white-text">
                                <p class="text-black">You can View Personnel Details.</p>
                            </div>
                            <button ng-click="submitnewpersonnellist(objproject)" class="btn cyan waves-effect waves-light" type="submit">View Personnel Count
                ...
                <?php if ($roledata['permissions']['EPREPORT'] == 1) { ?>
                    <div class="col s12 m6 l6">
                        <div class="card blue-grey lighten-1">
                            <div class="card-action">
                                <div class="card-content white-text">
                                    <p class="text-black">You can Export Personnel to an excel file.</p>
                                </div>
                                <!-- ng-click="exportdistrictcount(objproject)" -->
                                <button ng-click="exportnewpersonnellist(objproject)" class="btn cyan waves-effect waves-light" type="submit">Export Personnel Count
                                    <i class="mdi-content-send right"></i>
                                </button>
            ...
            <table ng-table="tableParams" class="responsive-table highlight striped" fixed-table-headers="scrollable-area" show-filter="true" class="bordered">
                <tbody ng-repeat="applied in $data">
                    <tr>
                        ...
                        <td width="20%" data-title="'CATEGORY'" filter="{CATEGORY: 'text'}" sortable="'CATEGORY'">{{applied.CATEGORY}}</td> 
                        <td width="20%" data-title="'MEMBERCOUNT'" filter="{MEMBERCOUNT: 'text'}" sortable="'MEMBERCOUNT'">{{applied.MEMBERCOUNT}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
