        ...
        <div class="container">
            ...
            <div class="col s12 m6 l6 right-align">
                ...
                <div class=""> <a href="<?php echo base_url('admin/dashboard')?>" class="breadcrumb">Home</a>
                    ...
                    <span class="breadcrumb">Staff</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="modal1" class="modal modal-fixed-footer" style=" max-height:90%;">
            <div class="modal-content">
                ...
                <div class="row" style="padding: 24px;">
                    <form autocomplete="off" ng-submit="employeeform.$valid && saveemployee(objemployee)"
                        id="employeeform" name="employeeform" novalidate>
                        <div class="row" style="padding: 40px;">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input autocomplete="off" id="firstname" name="firstname" type="text"
                                                ...
                                                ng-class="{'submitted': submitted && employeeform.firstname.$invalid}"
                                                class="validate" type="text" ng-required="true"
                                                ng-model="objemployee.firstname">
                                            <label for="firstname" data-error="Required (min 3 chars)"
                                                style="Width:100%">First Name</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input autocomplete="off" id="lastname" name="lastname" type="text"
                                                maxlength="150"
                                                ng-class="{'submitted': submitted && employeeform.lastname.$invalid}"
                                                class="validate" type="text" ng-required="true"
                                                ng-model="objemployee.lastname">
                                            <label for="lastname" data-error="Required">Last Name</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input autocomplete="off" id="employeeno" name="employeeno" type="text"
                                                maxlength="150"
                                                ng-class="{'submitted': submitted && employeeform.employeeno.$invalid}"
                                                class="validate" type="text" ng-required="true"
                                                ng-model="objemployee.employeeno">
                                            <label for="employeeno" data-error="Required">Staff No</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <select ng-required="true" name="regionid" ng-model="objemployee.regionid"
                                                ng-class="{'submitted': submitted && employeeform.regionid.$invalid}"
                                                data-ng-options=" rg.lkvalid as rg.description for rg in region">
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <select ng-required="true" name="desigid" ng-model="objemployee.desigid"
                                                ng-class="{'submitted': submitted && employeeform.desigid.$invalid}"
                                                data-ng-options=" de.lkvalid as de.description for de in designation">
                                            </select>
                                            <label for="desig" data-error="Required">Designation</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input autocomplete="off" id="doj" type="date" class="datepicker"
                                                type="text" data-ng-model="objemployee.doj">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input autocomplete="off" id="email" name="email" type="email"
                                                maxlength="150"
                                                ng-class="{'submitted': submitted && employeeform.email.$invalid}"
                                                class="validate" type="text" ng-model="objemployee.email"
                                                ng-required="true">
                                        ...
                                        <div class="input-field col s6">
                                            <input autocomplete="off" id="mobile" name="mobile" type="text"
                                                ...
                                                ng-class="{'submitted': submitted && employeeform.mobile.$invalid}"
                                                class="validate" ng-model="objemployee.mobile" ng-pattern="/^[0-9]*$/"
                                                ng-required="true" onkeypress="return isNumberKey(event);">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input autocomplete="off" id="phone" type="text" maxlength="15"
                                                class="validate" ng-model="objemployee.phone"
                                                onkeypress="return isNumberKey(event);">
                                            <label for="phone" data-error="Required">Phone</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input autocomplete="off" id="address" type="text" maxlength="200"
                                                class="validate" ng-model="objemployee.address">
                                            <label for="address">Address</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <select ng-model="objemployee.roleid" name="roleid"
                                                ng-class="{'submitted': submitted && employeeform.roleid.$invalid}"
                                                data-ng-options=" rl.roleid as rl.description for rl in roles"
                                                ng-required="true">
                                            </select>
                                            <label>Role</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input ng-minlength="6" maxlength="15" id="password" name="password"
                                                ng-class="{'submitted': submitted && employeeform.password.$invalid}"
                                                type="password" class="validate" type="text"
                                                ng-model="objemployee.password" ng-required="true"
                        ...
                        <ul class="collection">
                            ...
                            <div class="scroll">
                                <li class="collection-item avatar waves-effect waves-teal col s12"
                                    ng-class="{selected: employee.employeeid === selected.employeeid}"
                                    ng-repeat="employee in employees | filter: filter">
                                    <a href="javascript::void(0)" ng-click="select(employee)">
                                        <div style="margin-top: 10px;">
                                            <span class="circle light-blue"
                                                style="padding: 10px;">{{employee.firstname.slice(0,1)}}</span> <span
                                                class="email-title">
                                                {{employee.firstname}} {{employee.lastname}} -
                                                {{employee.employeeno}}</span>
                        ...
                        <div class="email-content-wrap">
                            <div class="row z-depth-1" style="background-color: #eee;">
                                    ...
                                    <ul class="collection">
                                        <li class="collection-item avatar" style="background-color:transparent">
                                            <img src="<?php echo base_url("assets/images/photo.png")?>" alt=""
                                                class="circle">
                                            <span class="email-title">{{selected.firstname}} {{selected.lastname}} -
                                                {{selected.employeeno}}</span>
                                ...
                                <div class="col s2 m2 l2 right-align resultframe">
                                    ...
                                    <a id="editemployee" ng-click="editemployee()"><span><i
                                                class="small icon darken-1 mdi mdi-account-edit"></i></span></a>
                                    <?php } ?>
                                    <?php if($roledata['permissions']['DEMPLOYEE']==1) {?>
                                    <a ng-click='removeemployee()'><span><i
                                                class="small icon mdi mdi-delete"></i></span></a>
                                    <?php } ?>
