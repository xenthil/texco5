...
<div ng-app="appVacancy"  ng-controller="ctrlVacancylist" ng-cloak>
            ...
            <div class="col s12 m8 l9">
               <div class="row" style="background-color:#f5f5f5;">
                  <div class="col s6 m8 l9">
                     <h5>Total {{count1}} found</h5>
                  </div>
               </div>
               <div class="row" ng-repeat="v in dgrvacancy.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage)) | filter : search |  filter:regionFilterclient">
               ...
               <ul class="pagination theme-pagi">
                  <pagination total-items="totalItems" ng-model="currentPage" ng-change="pagelength()" class="pagination-sm" items-per-page="itemsPerPage" max-size="maxSize"></pagination>
               </ul>
               <!-- Pagination --> 
