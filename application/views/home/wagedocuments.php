<script type="text/javascript" src="<?php echo base_url("assets/js/app/wagedocument.js")?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/lib/ng-file-upload.min.js")?>"></script>
<div class="parallax-container" style="background-color: rgba(0, 12, 78, 0.9)">
    <div class="row">
        <div class="container">
            <div class="col s12 m6 l6">
                <div class="pagebannertext white-text">Wage Documents</div>
            </div>
            <div class="col s12 m6 l6 right-align">
                <div class="dumheight hide-on-small-only"> </div>
                <div class=""> <a href="<?php echo base_url()?>" class="breadcrumb">Home</a> <a href="<?php echo base_url('/services')?>" class="breadcrumb">Our Services</a><span class="breadcrumb">Wage Documents</span> </div>
            </div>
        </div>
    </div>
    <div class="parallax">
