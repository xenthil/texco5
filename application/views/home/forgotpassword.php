...
<!-- <script type="text/javascript">var login = "<?php echo $_GET['changedVal'];?>"</script> -->
...
<body style="background:#3f51b5">
  ...
  <div id="login-page" class="row" style="width: 315px; height: 500px;" ng-app="appHome">
    <div class="col s12 z-depth-6 card-panel" ng-controller="ctrlForgot">
      <form class="login-form" ng-submit="forgotpwform.$valid && forgotpassword(userid, login)" id="forgotpwform" name="forgotpwform" novalidate>
        <div ng-init="login='<?php echo $_GET['changedVal'];?>'"></div>
        <div class="row">
          <div class="input-field col s12 center">
          <img src="<?php echo base_url("assets/images/photo.png")?>" alt="" class="circle responsive-img valign profile-image-login">
          <h5 class="center login-form-text">Forgot Password</h5>
        </div>
        </div>
        <div class="row margin">
        <div class="input-field col s12">
          <input id="username" name="username" type="text" ng-model="userid" ng-required="true" maxlength="200" ng-class="{'submitted': submitted && forgotpwform.username.$invalid}">
          <label for="username" data-error="Required">Email/Mobile</label>
        </div>
      </div>
      <div id="failure" class="red-text"></div>
        ...
        <div class="row">
          <div class="input-field col s6">
              <p class="margin left-align medium-small"> <a href="<?php echo base_url('login');?>">Login</a></p>
          </div>
          <div class="input-field col s6">
