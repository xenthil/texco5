...
<div class="row" ng-app="appAdminMember">
    <div class="container" ng-controller="ctrlAdminMember">
        ...
        <!-- <a href="<?php echo base_url() ?>member/adddependency">Add Dependents</a> -->
        ...
        <div id="" class="section">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <select name="skillid" ng-model="skillprof.skillid"
                            data-ng-options=" d.lkvalid as d.description for d in skills" aria-required="true">
                        </select>

                    </td>
                    <td style="padding-left: 80px;">
                        Specific Skill Training required
                    </td>
                    <td>
                        <input name="trainingfor" type="text" 
                            ng-class="{'submitted': submitted && profileform.trainingfor.$invalid}" class="validate"
                            ng-model="skillprof.trainingfor">
            ...
            <a class="btn waves-effect waves-light  cyan darken-2" ng-show="updatemember==0" type="submit" ng-click="saveskill(skillprof)">
                Save
            </a>
            <a class="btn waves-effect waves-light  cyan darken-2" ng-show="updatemember==1" type="submit" ng-click="updateskill(skillprof)">
                Update
            </a>
        </div>

        Please Click below button to add new dependency for Skill Development
        <div class="adddept"> <a class="btn waves-effect waves-light  cyan darken-2" href="<?php echo base_url (). "member/adddependency"?>">Add New Dependents </a> <a class="btn waves-effect waves-light  cyan darken-2" href="<?php echo base_url (). "member/dependency"?>">View Dependents </a> </div>
                        ...
                        <table style="font-weight: bold;">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col s6">
                                        ...
                                        <input id="firstname" type="text" name="firstname" class="validate"
                                            maxlength="250" ng-model="objregister.dependentName" ng-required="true"
                                    ...
                                    <div class="col s6">
                                        ...
                                        <label for="dob" style="font-size:12px;"> Date of Birth <span
                                                style="color: red;">
                                                *</span></label>
                                ...
                                <div class="row">
                                    <div class="col s6">
                                        ...
                                        <input id="aadhaarno" type="text" name="aadhaarno" class="validate"
                                            minlength="12" maxlength="12" ng-model="objregister.aadharNumber"
                                ...
                                <div class="row">
                                    <div class="col s6">
                                        ...
                                        <input id="educationalqualification" type="text" name="educationalqualification"
                                            ...
                                            ng-model="objregister.educationalQualification"
                                    ...
                                    <div class="col s6">
                                        ...
                                        <input id="technicalqualification" type="text" name="technicalqualification"
                                            class="validate" maxlength="150"
                                            ng-model="objregister.technicalQualification"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s6">
                                        <label for="trainingfor" style="font-size:12px;"> Specific Skill Training
                                            required
                                    ...
                                    <div class="file-field input-field">
                                        ...
                                        <div class="file-path-wrapper">
                                            <input class="file-path validate" type="text"
                                                ng-model="objregister.documentPath">
                                        </div>
