        ...
        <div class="nav-content indigo z-depth-2">
          <div class="container">
            <div class="header indigo  hide-on-med-and-down">
              ...
              <div class="right" style="width:30% !important">
                <ul class="left">
                 <li class="logdet" style="margin-top: 5px;">Welcome <?php echo $membername;?></li>
                  ...
                  <ul id='dropdown1' class='dropdown-content'>
                    <li class="black-text"><a href="<?php echo base_url('member/profile')?>"><i class="mdi mdi-face "></i> Profile</a> </li>
                    <li class="divider"></li>
                     <li><a href="<?php echo base_url("member/logout")?>"><i class="mdi mdi-logout-variant"></i> Sign Out</a> </li>
                  </ul>
                </ul>
                <div class="right">
        ...
        <div class="container">
          <div class="nav-wrapper"> <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="grey-text  material-icons">menu</i></a>
            <ul id="nav-mobile" class="right hide-on-med-and-down">
              ...
              <li class="black-text"><a class="waves-effect headermenuselect" href="<?php echo base_url('member/dashboard')?>">Dashboard</a></li>
              <li class="black-text"><a class="waves-effect headermenuselect" href="<?php echo base_url('member/profile')?>">Profile</a></li>
               <li class="black-text"><a class='dropdown-button waves-effect headermenuselect'  data-activates='vacancys'" href="<?php echo base_url('member/vacancy')?>">Vacancy</a></li>
                <!-- <ul id='vacancys' class='dropdown-content'>
                  <li class="black-text"><a class="waves-effect headermenuselect" href="<?php echo base_url('member/dgrvacancy')?>">DGR Vacancy</a></li>
                  <li class="black-text"><a class="waves-effect headermenuselect" href="<?php echo base_url('member/tnvacancy')?>">TN Vacancy</a></li>
                </ul> -->
              <li class="black-text"><a class="waves-effect headermenu " href="<?php echo base_url('member/history')?>">Job History</a></li>

              <li class="black-text"><a class="waves-effect headermenu " href="<?php echo base_url('member/dependency')?>">Dependency</a></li>

              <li class="black-text"><a class="waves-effect headermenu " href="<?php echo base_url('member/jobhistory')?>">History</a></li>
              
              <li class="black-text"><a class="waves-effect headermenu logout-menu" href="<?php echo base_url('member/logout')?>"> Sign Out</a></li>
            </ul>
            <ul class="side-nav" id="mobile-demo">
	            <li class="black-text"><a class="waves-effect" href="<?php echo base_url('member/dashboard')?>">Dashboard</a></li>
              <li class="black-text"><a class="waves-effect" href="<?php echo base_url('member/profile')?>">Profile</a></li>
              <li class="black-text"><a class="waves-effect" href="<?php echo base_url('member/newvacancy')?>">Vacancy</a></li>
              <li class="black-text"><a class="waves-effect" href="<?php echo base_url('member/history')?>">Job History</a></li>
               <li class="black-text"><a class="waves-effect" href="<?php echo base_url('member/jobhistory')?>">History</a></li>

               <li class="black-text"><a class="waves-effect" href="<?php echo base_url('member/logout')?>">Logout</a></li>
