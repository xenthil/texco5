<footer class="page-footer">
  ...
  $('.dropdown-button').dropdown({
    ...
    $('.modal').modal({
       ...
       // complete: function() { Materialize.toast('Closed', 3000, 'red'); } // Callback for Modal close
      }
    );    </script>
...
(function() {
  ...
  if (memid !='')
  {
    ...
    const redirectUrl = '<?php //echo base_url()?>'+'member/logout';  // Redirect idle users to this URL
