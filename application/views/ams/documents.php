    ...
    <div class="row">
        <div class="container">
            ...
            <div class="col s12 m6 l6 right-align">
                ...
                <div class=""> <a href="<?php echo base_url('admin/dashboard')?>" class="breadcrumb">Home</a> <span class="breadcrumb">Documents</span> </div>
            </div>
        </div>
    </div>
...
<div class="row" ng-app="appDocument">
    <div class="container" ng-controller="ctrlDocument">
        ...
        <div class="fixed-action-btn" style="bottom: 50px; right: 19px;">
            ...
            <a class="btn-floating btn-large red modal-trigger" href="#modal1" ng-click='adddocument()'>
