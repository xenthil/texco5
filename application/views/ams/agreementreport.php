   ...
   <div class="row">
      <div class="container">
         ...
         <div class="col s12 m6 l6 right-align">
            ...
            <div class=""> <a href="<?php echo base_url('admin/dashboard')?>" class="breadcrumb">Home</a> <span class="breadcrumb">Agreement Report</span> </div>
         </div>
      </div>
   </div>
         ...
         <div class="row">
            ...
            <div class="col s12 m6 l6">
               <div class="card blue-grey lighten-1">
                  <div class="card-action">
                     <div class="card-content white-text">
                        <p class="text-black">You can Export all Agreements, from an excel file.</p>
                     </div>
                     <button ng-click="exportagreement(objagreement)" class="btn cyan waves-effect waves-light" type="submit">Export Agreements
                     <i class="mdi-content-send right"></i>
                     </button>
                  </div>
               </div>
         ...
         <table ng-table="tableParams" class="responsive-table highlight striped" show-filter="true" class="bordered">
            <tbody ng-repeat="item in $data" >
               <tr>
                  ...
                  <td  width="6%" data-title="'SGSALARY'" filter="{sgsalary: 'number'}" sortable="'sgsalary'">{{item.sgsalary}}</td>
                   <td width="6%"  data-title="'HSG'" filter="{hsg: 'number'}" sortable="'hsg'">{{item.hsg}}</td>
                  <td  width="6%" data-title="'HSGSALARY'" filter="{hsgsalary: 'number'}" sortable="'hsgsalary'">{{item.hsgsalary}}</td>
                   <td  width="6%" data-title="'DVR'" filter="{dvr: 'number'}" sortable="'dvr'">{{item.dvr}}</td>
                  <td  width="6%" data-title="'DVRSALARY'" filter="{dvrsalary: 'number'}" sortable="'dvrsalary'">{{item.dvrsalary}}</td>
                   <td  width="6%" data-title="'ASO'" filter="{aso: 'number'}" sortable="'aso'">{{item.aso}}</td>
                  <td  width="6%" data-title="'ASOSALARY'" filter="{asosalary: 'number'}" sortable="'asosalary'">{{item.asosalary}}</td>
                  <td  width="6%" data-title="'PO'" filter="{po: 'number'}" sortable="'po'">{{item.po}}</td>
                  <td  width="6%" data-title="'POSALARY'" filter="{posalary: 'number'}" sortable="'posalary'">{{item.posalary}}</td>
                  <td  width="6%" data-title="'JA'" filter="{ja: 'number'}" sortable="'ja'">{{item.ja}}</td>
                 <td  width="6%" data-title="'JASALARY'" filter="{jasalary: 'number'}" sortable="'jasalary'">{{item.jasalary}}</td>
                  <td  width="6%" data-title="'OTHER'" filter="{other: 'number'}" sortable="'other'">{{item.other}}</td>
                 <td  width="6%" data-title="'OTHERSALARY'" filter="{othersalary: 'number'}" sortable="'othersalary'">{{item.othersalary}}</td>
                  <td  width="6%" data-title="'OA'" filter="{oa: 'number'}" sortable="'oa'">{{item.oa}}</td>
                 <td  data-title="'OASALARY'" filter="{oasalary: 'number'}" sortable="'oasalary'">{{item.oasalary}}</td>
                 <td  width="6%" data-title="'GUN'" filter="{gun: 'number'}" sortable="'gun'">{{item.gun}}</td>
                 <td  width="6%" data-title="'GUNSALARY'" filter="{gunsalary: 'number'}" sortable="'gunsalary'">{{item.gunsalary}}</td>
                  <td width="6%"  data-title="'EMPLOYERADDRESS1'" filter="{addressline1: 'text'}" sortable="'addressline1'">{{item.addressline1}}</td>
                  <td width="6%" data-title="'EMPLOYERADDRESS2'" filter="{addressline2: 'text'}" sortable="'addressline2'">{{item.addressline2}}</td>
                  <td width="6%"  data-title="'EMPLOYERADDRESS3'" filter="{addressline3: 'text'}" sortable="'addressline3'">{{item.addressline3}}</td>
                  <td width="6%" data-title="'EMAIL'" filter="{email: 'text'}" sortable="'email'">{{item.email}}</td>
                  <td  width="6%" data-title="'MOBILE'" filter="{mobile: 'text'}" sortable="'mobile'">{{item.mobile}}</td>
                  <td width="6%" data-title="'PHONE'" filter="{phone: 'text'}" sortable="'phone'">{{item.phone}}</td>
                  <td  width="6%" data-title="'GSTNO'" filter="{gstno: 'text'}" sortable="'gstno'">{{item.gstno}}</td>
                  <td width="6%" data-title="'PANNO'" filter="{panno: 'text'}" sortable="'panno'">{{item.panno}}</td>
                  ...
                  <td width="6%" data-title="'STATE'" filter="{state: 'text'}" sortable="'state'">{{item.state}}</td>
                  <td width="6%" data-title="'COUNTRY'" filter="{country: 'text'}" sortable="'country'">{{item.country}}</td>
                  <td  width="6%" data-title="'REGION'" filter="{region: 'text'}" sortable="'region'">{{item.region}}</td>
                  <td width="6%" data-title="'DEPARTMENTTYPE'" filter="{departmenttype: 'text'}" sortable="'departmenttype'">{{item.departmenttype}}</td>
                  <td width="6%" data-title="'DEPARTMENTNAME'" filter="{department: 'text'}" sortable="'department'">{{item.department}}</td>
                  <td width="6%" data-title="'DESIGNATION'" filter="{designation: 'text'}" sortable="'designation'">The {{item.designation}}</td>
                  <td width="6%" data-title="'PROJADDRESS1'" filter="{projectaddress1: 'text'}" sortable="'projectaddress1'">{{item.projectaddress1}}</td>
                  <td width="6%" data-title="'PROJADDRESS2'" filter="{projectaddress2: 'text'}" sortable="'projectaddress2'">{{item.projectaddress2}}</td>
                  <td width="6%" data-title="'PROJADDRESS3'" filter="{projectaddress3: 'text'}" sortable="'projectaddress3'">{{item.projectaddress3}}</td>
                  <td width="6%" data-title="'PINCODE'" filter="{pincode: 'text'}" sortable="'pincode'">{{item.pincode}}</td>
               </tr>
            </tbody>
         </table>
