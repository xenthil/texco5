<script type="text/javascript" src="
   <?php echo base_url("assets/js/app/invoice.js")?>"></script>
   ...
   <div class="container" ng-controller="pendingattctrl">
    ...
    <div id="modal2" class="modal modal-fixed-footer" style="max-height:90%; width:90%">
       ...
       <form id="attendanceform" ng-submit="attendanceform.$valid"  name="attendanceform" novalidate>
                     <div class="row">
                        <div class="input-field col s6 l3">
                          ...
                          <input name="month_year" id="month_year" class="month_year" type="text" ng-model="objattendance.monthandyeasr"/>
                        </div>
                        <div class="col s12">
                           <table class="striped">
                              <tr>
      ...
      <div class="input-field col m3 s6">
		<input name="month_year" id="month_year" class="month_year" type="text" ng-model="objattendance.monthandyear" ng-change="getinvoice(objattendance.monthandyear)"/>
         ...
         <div id="Client-details" class="col s12">
            <table ng-table="tableParams" class="responsive-table highlight striped" show-filter="true" class="bordered" >
               <tr ng-repeat="applied in $data">
                  ...
                  <td width="15%" data-title="'VIEW ATTENDANCE'"><a ng-click="openattendance(applied.monthandyear,applied.projectid)">View Attendance</a></td>
                  <td width="20%" data-title="'GENERATE INVOICE/INVOICE NUMBER'">
                    <span ng-show="applied.invoiceno==null" > <a class="btn-floating btn-small blue"  ng-click="generateinvoice(applied.projectid,applied.monthandyear)">
                     <i class="material-icons">done</i>
                     </a>
                     </span>
                     <span ng-show="applied.invoiceno!=''" ><a href="<?php echo base_url('admin/printinvoice?invoiceno={{applied.invoiceno}}')?>" target="_blank">{{applied.invoiceno}}</a></span>
                  </td>
               </tr>
            </table>
