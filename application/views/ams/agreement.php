...
<script type="text/javascript" src="<?php echo base_url("assets/js/app/agreement.js") ?>"></script>
...
<div class="row" ng-app="appAgreement">
   <div class="container" ng-controller="ctrlAgreement">
      ...
      <div class="fixed-action-btn" style="bottom: 140px; right: 19px;">
         <?php if ($roledata['permissions']['AAGREE'] == 1) { ?>
            <a class="btn-floating btn-large red modal-trigger tooltipped" ng-click='addagreement()' data-position="bottom" data-delay="50" data-tooltip="Single Agreement">
      ...
      <div class="fixed-action-btn" style="bottom: 50px; right: 19px;">
         <?php if ($roledata['permissions']['AAGREE'] == 1) { ?>
            <a class="btn-floating btn-large red modal-trigger tooltipped" ng-click='addcombinedagreement()' data-position="bottom" data-delay="50" data-tooltip="Combined Agreement">
               <i class="mdi mdi-account-plus"></i>
            </a>
         <?php } ?>
      </div>
         ...
         <div class="modal-content">
            <nav class="blue" style="position: fixed;margin-top: 0px; z-index:999">
               ...
               <div class="col s11 m11 l11">
                  <div class="li white-text" id="m3caption">Edit Agreement</div>
               </div>
            </nav>
                     ...
                     <div class="col s12">
                        <div class="row">
                           <div class="input-field col s6">
                              <select id="client" name="client" class="validate" ng-required="true" ng-class="{'submitted': submitted && agreementform.client.$invalid}" ng-model="objagreement.clientid" data-ng-options=" c.clientid as c.organization for c in clientslists" ng-change="selectProject(objagreement.clientid)">
                              </select><label for="client">Employer</label>
                           </div>
                           <div class="input-field col s6">
                              <select id="agreementtypeid" name="agreementtypeid" class="validate" ng-required="true" ng-class="{'submitted': submitted && agreementform.agreementtype.$invalid}" ng-model="objagreement.agreementtypeid" data-ng-options="at.lkvalid as at.description for at in agreementtype" ng-change='getagtype(objagreement)'>
                        ...
                        <div class="row">
                           <div class="input-field col s6">
                              <select id="wagetype" name="wagetype" class="validate" ng-required="true" ng-class="{'submitted': submitted && agreementform.wagetype.$invalid}" ng-model="objagreement.wagetype" data-ng-options="at.lkvalid as at.description for at in wagetype" ng-change='getwagetype(objagreement.wagetype,objagreement.wageyearid)'>
                        ...
                        <div class="row">
                           <div class="input-field col s6">
                              <input id="fromdate" type="date" class="datepicker" type="text" ng-class="{'submitted': submitted && agreementform.fromdate.$invalid}" data-ng-model="objagreement.fromdate" ng-required="true">
                              <label for="fromdate" data-error="Required">From date</label>
                           </div>
                           <div class="input-field col s6">
                              <input id="todate" type="date" class="datepicker" type="text" ng-class="{'submitted': submitted && agreementform.todate.$invalid}" data-ng-model="objagreement.todate" ng-required="true">
                              <label for="todate" data-error="Required">To Date</label>
                           </div>
                        </div>
                        <div class="row">
                           <div class="input-field col s6">
                              <select id="wagerate" name="wagerate" class="validate" ng-required="true" ng-class="{'submitted': submitted && agreementform.wagerate.$invalid}" ng-model="objagreement.wageyearid" data-ng-options="at.lkvalid as at.description for at in wagerate" ng-change='getchangecategory(objagreement.wageyearid,objagreement.wagetype)' ng-change='getchangecategory(objagreement.wageyearid,objagreement.wagetype)'>
                           ...
                           <div class="input-field col s6" ng-if="objagreement.wageyearid">
                              <select id="wagecategoryid" name="wagecategoryid" class="validate" ng-model="objagreement.wagecategoryid" data-ng-options="at.category_id as at.category_code + ' - ' + at.category_description for at in wagecategories" ng-required="true">
                              </select>
                        ...
                        <div class="row">
                           <div class="input-field col s6" ng-hide="objagreement.wagetype==tncode">
                              <select id="wagearea" name="wagearea" class="validate" ng-model="objagreement.wageareaid" data-ng-options="at.lkvalid as at.description for at in wagearea">
                              </select>
                              <label for="wagearea">Wage Area</label>
                           </div>
                           <div class="input-field col s6">
                              <select id="typeagreement" name="typeagreement" class="validate" ng-required="true" ng-class="{'submitted': submitted && agreementform.typeagreement.$invalid}" ng-model="objagreement.typeagreement" data-ng-options="at.lkvalid as at.description for at in typeofagreement" ng-change='getagreementtype(objagreement.typeagreement)'>
               ...
               <form ng-submit="agreementform.$valid && saveagreement(objagreement, selectedObjects)" id="agreementform" name="agreementform" novalidate>
                  ...
                  <div class="row">
                     <div class="col s12">
                        <div class="row">
                           <div class="input-field col s6">
                              <select id="projectno" name="projectno" class="validate" ng-class="{'submitted': submitted && objagreement.client.$invalid}" ng-model="objagreement.projectid" data-ng-options=" p.projectid as p.projectno for p in projectnos" ng-change="fillclientproject(objagreement.projectid)">
                              </select><label for="client">Project No</label>
                           </div>
                           <div class="input-field col s6">
                              <select id="client" name="client" class="validate" ng-required="true" ng-class="{'submitted': submitted && agreementform.client.$invalid}" ng-model="objagreement.clientid" data-ng-options=" c.clientid as c.organization for c in clients" ng-change="selectProject(objagreement.clientid)">
                              </select><label for="client">Employer</label>
                           </div>
                        </div>
                        <div class="row">
                           <div class="input-field col s6">
                              <div class="form-group" ng-hide="objagreement.agreementtypeid==COMBINED">
                              ...
                              <div class="form-group" ng-hide="objagreement.agreementtypeid==single">
                                 <div isteven-multi-select input-model="projectnames" output-model="selectedprojectslist" button-label="name" item-label="name" on-item-click='getmultivals(data)' tick-property="ticked" style="width:100%">
                                 </div>
                              </div>
                           </div>
                           <div class="input-field col s6">
                              <select id="wagetype" name="wagetype" class="validate" ng-required="true" ng-class="{'submitted': submitted && agreementform.wagetype.$invalid}" ng-model="objagreement.wagetype" data-ng-options="at.lkvalid as at.description for at in wagetype" ng-change='getwagetype(objagreement.wagetype,objagreement.wageyearid)' ng-disabled="functions=='edit'">
                              </select><label for="wagetype">Wage Type</label>
                           </div>
                        </div>
                        <div class="row">
                           <div class="input-field col s6">
                              <input id="fromdate" type="date" class="datepicker" type="text" data-ng-model="objagreement.fromdate" ng-required="true" ng-disabled="functions=='edit'">
                              <label for="fromdate">From date</label>
                           </div>
                           <div class="input-field col s6">
                              <input id="todate" type="date" class="datepicker" type="text" data-ng-model="objagreement.todate" ng-required="true" ng-disabled="functions=='edit'">
                        ...
                        <!--  <div class="row" id="divProjView">
                           <div class="input-field col s6">
                              <input id="clientdesc" readonly  ng-model="objagreement.organization" maxlength="100" ng-disabled="functions=='edit'">
                              </input><label for="clientdesc">Employer</label>
                           </div>
                           <div class="input-field col s6">
                              <input id="projectname" readonly class="validate"  ng-model="objagreement.projectname" maxlength="100" ng-disabled="functions=='edit'">
                        ...
                        <div class="row">
                           ...
                           <div class="input-field col s6">
                              <select id="agreementtypeid" name="agreementtypeid" class="validate" ng-required="true" ng-class="{'submitted': submitted && agreementform.agreementtype.$invalid}" ng-model="objagreement.agreementtypeid" data-ng-options="at.lkvalid as at.description for at in agreementtype" ng-disabled="functions=='edit'" ng-change='getagtype(objagreement)'>
                              </select><label for="agreementtype">Agreement Type</label>
                           </div>
                        </div>
      ...
      <div id="jobsedit" class="modal modal-fixed-footer" style="max-height:90%;">
         <div class="modal-content">
            <nav class="blue" style="position: fixed;margin-top: 0px; z-index:999">
               ...
               <div class="col s11 m11 l11">
                  <div class="li white-text" id="mcaptions">Edit Vacancy</div>
               </div>
            </nav>
            <form ng-submit="addaddendumform.$valid && saveaddendum(objagreement, updatejobs,2)" id="addaddendumform" name="addaddendumform" novalidate style="padding: 50px;">
               <div class="input-field col s12">
                  <table>
                     <tr>
                        <th>Postings</th>
      ...
      <div id="addendumedit" class="modal modal-fixed-footer" style="max-height:90%;">
         <div class="modal-content">
            ...
            <form ng-submit="addaddendumform.$valid && updateaddendum(objagreement, updatejobss)" id="addaddendumform" name="addaddendumform" novalidate style="padding: 50px;">
               <div class="input-field col s12">
                  <table>
                     <tr>
                        <th> Addendum </th>
      ...
      <div class="row">
         ...
         <div class="input-field col m2 s6"> 
               <button type="button" class="btn btn-default btncol" ng-click="downloadagreement(objattendance)" style="background: green;color: #fff !important;float:right;margin:10px;"><span class="glyphicon glyphicon-download-alt">&nbsp;</span>Export</button>
         </div>
      </div>
      <br>
      <div class="row"> 
         <div class="col s12">
            <ul class="tabs">
               ...
               <li class="tab col s3"><a ng-click="getrejected()" id="Renewal" href="#rejected"><span class="badge" style="margin-top: 10px;background-color: #ee6e73;width: 45px;">{{rejectedcount}}</span>Admin Rejected</a></li>
            </ul>
         </div>
                  ...
                  <div class="col s12 ">
                     <div id="Client-list" class="CLheight col s12 m4 l4 card-panel z-depth-1">
                        <ul class="collection">
                              ...
                              <div class="col s12">
                                 <nav class="indigo">
                                    <div class="nav-wrapper">
                                       ...
                                       <div class="input-field col s8"> <i class="material-icons prefix">search</i>
                                          <input id="icon_prefix" placeholder="search" type="text" class="validate" ng-model="filter1" ng-change="searchRejectAgreement(filter1)">
                                       </div>
                                    </div>
                                 </nav>
                              </div>
                           ...
                           <div class="scroll">
                              <li ng-if="!filterproj1" class="collection-item avatar waves-effect waves-teal col s12" ng-class="{selected: agreement.agreementid === selected.agreementid}" ng-repeat="agreement in agreementsrejected | orderBy:agreement.projects[0].projectno" ng-click="select(agreement)">
                                 <a href="javascript::void(0)">
                                    <div style="margin-top: 10px;">
                                       <span class="circle light-blue" style="padding: 10px;">{{agreement.organization.slice(0,1)}}</span> <span class="email-title"></span>
                                       <p class="truncate grey-text ultra-small">{{agreement.projects[0].projectno}}-{{agreement.organization}}</p>
