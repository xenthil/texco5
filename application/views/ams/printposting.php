        ...
        <tbody>
            <tr>
                <td width="100%" align="center">
                    <table width="99%" align="center" cellpadding="0" cellspacing="0" border="0" style="padding-top: 20px;">
                        <tbody>
                            <tr>
                    ...
                    <table width="99%" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <span style="float: right;"><b>Dated:</b> <?php echo date("d-m-Y");?></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <table width="99%" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody style="text-align: justify;">
                            ...
                            <tr>
                                <td>
                                <br />
                                &nbsp; &nbsp; &nbsp; &nbsp; <strong>Ref:</strong>   The Contract agreement signed by the Ex-Servicemen dated <?php echo date("d-m-Y");?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table width="99%" cellspacing="0" cellpadding="0" align="center">
                        <tbody>
                            ...
                            <tr>
                                <td style="text-align: justify;" align="left">1. The above-mentioned individual(s) is/are hereby advised to join duty within 03 days from the date of issue of this order. Failing which, this order will be treated as cancelled.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                 <td style="text-align: justify;" align="left">
                                 <br />
                                 3. You are advised to open the SB Account in any IOB branch and mentioned 15 digit account number in
