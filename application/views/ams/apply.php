            ...
            <div class="col s12 m12 l12">
                ...
                <div class="row">
                    ...
                    <div class="input-field col  s12 m2 l2 center-align">
                        <button id="btntexser" class="waves-effect waves-light btn blue" type="submit" ng-click='memberinfo(objapply.texserno)'>View</button>
                    </div>
            ...
            <div id="Existingmember" style="display:none;" class="col s12 m12 l12 card-panel z-depth-1">
                ...
                <div class="row">
                    <div class="col s12 m12 l12">
                        ...
                        <div class="row" style="    line-height: 40px;">
                          <div class="col s12 m12 l12">
                          <button class="waves-green btn-flat" type="button" ng-click='cancelapply()'>
                              Cancel
                          </button>
                          &nbsp;&nbsp;&nbsp;
