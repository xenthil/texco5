                ...
                <table ng-table="tableParams" class="responsive-table highlight striped" show-filter="true"
                    ...
                    <tbody ng-repeat="applied in $data">
                        ...
                        <td width="8%" data-title="'Application Number'" filter="{applicationnumber: 'text'}"
                               ...
                               <span ng-show="applied.applicationnumber == 0">-</span>
                              </td>
...
TamilNadu'" filter="{anywhere: 'text'}"
        ...
        <div id="modal1" class="modal">
         ...
         <div class="modal-footer">
            <p ng-show="unavailable == 0">vacancy already filled</p>
            <a ng-show="unavailable != 0" ng-click="amsconfirmjob(jobprint.documentid,jobprint.memberid)" class="waves-effect waves-green btn-flat modal-action modal-close">Confirm</a>
