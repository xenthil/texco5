									...
									<div class="row">
												...
												<div class="col s12">
													...
													<table ng-table="tableParams"  class="responsive-table highlight striped" show-filter="true" class="bordered" >
														<tr ng-repeat="l in $data" ng-show="l.jobcode != 'DVR'">
															...
															<td width="17%"  data-title="'Name'" filter="{firstname: 'text'}">{{l.firstname}}<br>
															<span class="rejreason" ng-show="l.reason !=0">{{l.reason}}</span>
															</td>
                                       ...
                                       border-bottom:none" type="text" value="ED 2" />
															...
															<td  data-title="'1'">
																...
																<input type="checkbox" name="od" id="{{l.memberid}}3" ng-disabled="l.one == 0" class="filled-in" ng-checked="l.od2one == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2one"/>
															...
															<td  data-title="'2'">
																...
																<input type="checkbox" name="od" id="{{l.memberid}}6" ng-disabled="l.two == 0" class="filled-in" ng-checked="l.od2two == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2two" />
															...
															<td  data-title="'3'">
																...
																<input type="checkbox" name="od" id="{{l.memberid}}9" ng-disabled="l.three == 0" class="filled-in" ng-checked="l.od2three == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2three" />
															...
															<td  data-title="'4'">
																...
																<input type="checkbox" name="od" id="{{l.memberid}}12" ng-disabled="l.four == 0" class="filled-in" ng-checked="l.od2four == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2four" />
															...
															<td  data-title="'5'">
																...
																<input type="checkbox" name="od" id="{{l.memberid}}15" ng-disabled="l.five == 0" class="filled-in" ng-checked="l.od2five == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2five" />
															...
															<td  data-title="'6'">
																...
																<input type="checkbox" id="{{l.memberid}}18" ng-disabled="l.six == 0" class="filled-in" ng-checked="l.od2six == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2six" />
															...
															<td  data-title="'7'">
																...
																<input type="checkbox" id="{{l.memberid}}21" ng-disabled="l.seven == 0" class="filled-in" ng-checked="l.od2seven == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2seven" />
															...
															<td  data-title="'8'">
																...
																<input type="checkbox" id="{{l.memberid}}24" ng-disabled="l.eight == 0" class="filled-in" ng-checked="l.od2eight == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2eight" />
															...
															<td  data-title="'9'">
																...
																<input type="checkbox" id="{{l.memberid}}27" ng-disabled="l.nine == 0" class="filled-in" ng-checked="l.od2nine == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2nine" />
															...
															<td  data-title="'10'">
																...
																<input type="checkbox" id="{{l.memberid}}30" ng-disabled="l.ten == 0" class="filled-in" ng-checked="l.od2ten == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2ten" />
															...
															<td  data-title="'11'">
																...
																<input type="checkbox" id="{{l.memberid}}33" ng-disabled="l.eleven == 0" class="filled-in" ng-checked="l.od2eleven == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2eleven" />
															...
															<td  data-title="'12'">
																...
																<input type="checkbox" id="{{l.memberid}}36" ng-disabled="l.twelve == 0" class="filled-in" ng-checked="l.od2twelve == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twelve" />
															...
															<td  data-title="'13'">
																...
																<input type="checkbox" id="{{l.memberid}}39" ng-disabled="l.thirteen == 0" class="filled-in" ng-checked="l.od2thirteen == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2thirteen" />
															...
															<td  data-title="'14'">
																...
																<input type="checkbox" id="{{l.memberid}}42" ng-disabled="l.fourteen == 0" class="filled-in" ng-checked="l.od2fourteen == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2fourteen" />
															...
															<td  data-title="'15'">
																...
																<input type="checkbox" id="{{l.memberid}}45" ng-disabled="l.fifteen == 0" class="filled-in" ng-checked="l.od2fifteen == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2fifteen" />
															...
															<td  data-title="'16'">
																...
																<input type="checkbox" id="{{l.memberid}}48" ng-disabled="l.sixteen == 0" class="filled-in" ng-checked="l.od2sixteen == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2sixteen" />
															...
															<td  data-title="'17'">
																...
																<input type="checkbox" id="{{l.memberid}}51" ng-disabled="l.seventeen == 0" class="filled-in" ng-checked="l.od2seventeen == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2seventeen" />
															...
															<td  data-title="'18'">
																...
																<input type="checkbox" id="{{l.memberid}}54" ng-disabled="l.eighteen == 0" class="filled-in" ng-checked="l.od2eighteen == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2eighteen" />
															...
															<td  data-title="'19'">
																...
																<input type="checkbox" id="{{l.memberid}}57" ng-disabled="l.nineteen == 0" class="filled-in" ng-checked="l.od2nineteen == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2nineteen" />
															...
															<td  data-title="'20'">
																...
																<input type="checkbox" id="{{l.memberid}}60" ng-disabled="l.twenty == 0" class="filled-in" ng-checked="l.od2twenty == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twenty" />
															...
															<td  data-title="'21'">
																...
																<input type="checkbox" id="{{l.memberid}}63" ng-disabled="l.twentyone == 0" class="filled-in" ng-checked="l.od2twentyone == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twentyone" />
															...
															<td  data-title="'22'">
																...
																<input type="checkbox" id="{{l.memberid}}66" ng-disabled="l.twentytwo == 0" class="filled-in" ng-checked="l.od2twentytwo == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twentytwo" />
															...
															<td  data-title="'23'">
																...
																<input type="checkbox" id="{{l.memberid}}69" ng-disabled="l.twentythree == 0" class="filled-in" ng-checked="l.od2twentythree == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twentythree" />
															...
															<td  data-title="'24'">
																...
																<input type="checkbox" id="{{l.memberid}}72" ng-disabled="l.twentyfour == 0" class="filled-in" ng-checked="l.od2twentyfour == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twentyfour" />
															...
															<td  data-title="'25'">
																...
																<input type="checkbox" id="{{l.memberid}}75" ng-disabled="l.twentyfive == 0" class="filled-in" ng-checked="l.od2twentyfive == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twentyfive" />
															...
															<td  data-title="'26'">
																...
																<input type="checkbox" id="{{l.memberid}}78" ng-disabled="l.twentysix == 0" class="filled-in" ng-checked="l.od2twentysix == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twentysix" />
															...
															<td  data-title="'27'">
																...
																<input type="checkbox" id="{{l.memberid}}81" ng-disabled="l.twentyseven == 0" class="filled-in" ng-checked="l.od2twentyseven == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twentyseven" />
															...
															<td  data-title="'28'" ng-if="noOfDays>=28">
																...
																<input type="checkbox" id="{{l.memberid}}84" ng-disabled="l.twentyeight == 0" class="filled-in" ng-checked="l.od2twentyeight == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2twentyeight" />
															...
															<td  data-title="'29'" ng-if="noOfDays>=29">
																...
																<input type="checkbox" id="{{l.memberid}}87" ng-disabled="l.twentynine == 0" class="filled-in" ng-checked="l.od2twentynine == .5" ng-true-value=".5" ng-false-value="0"  ng-model="l.od2twentynine" />
															...
															<td  data-title="'30'" ng-if="noOfDays>=30">
																...
																<input type="checkbox" id="{{l.memberid}}90" ng-disabled="l.thirty == 0" class="filled-in" ng-checked="l.od2thirty == .5" ng-true-value=".5" ng-false-value="0" ng-model="l.od2thirty" />
															...
															<td  data-title="'31'" ng-if="noOfDays>=31">
																...
																<input type="checkbox" id="{{l.memberid}}93" ng-disabled="l.thirtyone == 0" class="filled-in" ng-checked="l.od2thirtyone == .5" ng-true-value=".5" ng-false-value="0"  ng-model="l.od2thirtyone" />
