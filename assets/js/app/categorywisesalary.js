...
app.controller('ctrlCategoryWisereport', function ($scope, $http, $filter, NgTableParams) {
	...
	$scope.objproject = {'fromdate':$scope.lastdate,'todate':$scope.currentdate,'regionid':0,'districtid':0};
    ...
    $scope.viewcategorylist = function (objproject) { 
        ...
        $http({
            ...
            url: api_url + '/getcategoryreportlist',
            data: $.param({
