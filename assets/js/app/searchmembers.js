var app = angular.module('appAdminSearchMember', ['ngTable']);
app.controller('ctrlAdminSearchMember', function($scope, $http, $filter, NgTableParams) {
...
debugger
    ...
    $scope.searchmember = function (serviceno) {
		$http({
			...
			url: api_url + "/getmembersearchold?membersearchval=" + serviceno,
		}).then(function successCallback(response) {
            debugger
			if (response.status = 200) {
